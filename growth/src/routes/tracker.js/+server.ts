...
const SOURCE = String.raw`(() => {
  ...
  try{var replay=document.createElement('script');replay.src=ORIGIN+'/replay.js?v=20260909-1';replay.async=true;replay.crossOrigin='anonymous';document.head.appendChild(replay);}catch(e){}
})();`;
