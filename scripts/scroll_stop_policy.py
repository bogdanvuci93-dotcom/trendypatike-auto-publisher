...
- Write for a broad SERBIAN Instagram audience, not only sneaker collectors. Prefer angles Serbians instantly understand and talk about: NBA/basketball, globally famous football/sports names when footwear is central, hip-hop/music, 1990s/2000s nostalgia, huge money, brand rivalries, scandals/myths, bizarre inventions and famous pop-culture moments.
- When two factual topics are equally strong, prefer the one with a stronger Serbian connection or stronger recognition in Serbia. Serbian athletes such as Nikola Jokić are high priority when the shoe story itself is genuinely newsworthy and verifiable.
- Serbian copy must sound like a sharp native social-media editor, not a translated article. Use natural everyday Serbian, concrete verbs and a payoff people would repeat to a friend.
...
- Every used slide must answer: "Zašto bi neko u Srbiji ko ne zna mnogo o patikama nastavio da čita?" If the answer is only technical knowledge, rewrite or reject.''')
...
- The Serbian should sound conversational, current and native. Prefer "Nike je platio...", "Jordan je uradio...", "Dva brata su se posvađala..." over abstract wording such as "uticao je na razvoj".
...
'''- The story must have a strong mass-interest hook. A famous name ALONE is not enough. The angle itself must include at least one strong reason to click: extraordinary verified money, record, extreme rarity/quantity, famous controversy or myth, iconic film/music moment, unbelievable design story, historic sports moment or a rivalry people already recognize.
- Optimize for Serbia: basketball/NBA, major sports stars, hip-hop/music, big brand rivalries, 1990s/2000s nostalgia, shocking prices and "čekaj, stvarno?" facts usually beat niche US sneaker-industry trivia.
...
'''- Reject weak or broad angles even when they contain a famous person. A famous name is NOT sufficient by itself. The actual angle must contain a concrete mass-interest payoff: extraordinary money, record, extreme rarity/quantity, controversy/myth, famous film/music/sports moment, recognizable rivalry or unbelievable invention/design story.
- Prefer topics that a Serbian non-sneaker fan would still send to a friend. If the appeal depends on knowing a niche US college, obscure designer, technical foam name or release code, reject it unless there is a much bigger story attached.
...
# Fresh-topic discovery must pass a tougher viral-interest test and be Serbia-aware.
s = s.replace(
...
'''Before choosing, apply THREE tests. (1) Would someone in Serbia who does NOT follow sneaker culture understand why this is interesting in one second? (2) Can the cover be written as a 5-10 word hook containing a concrete payoff such as money, record, rarity, controversy/myth, famous rivalry or famous event? (3) Would this be more shareable in Serbia than a niche technical sneaker fact? If any answer is no, reject the topic and choose another. A famous athlete name by itself does NOT pass. Strong Serbian relevance, NBA/basketball, mainstream music, 1990s/2000s nostalgia and globally recognizable brand rivalries get priority when facts are equally strong.''')

CONTENT.write_text(s, encoding="utf-8")
print("Scroll-stop policy applied: Serbia-aware viral hooks, shorter copy, 1-2 slide default, cinematic fact-matched images.")
